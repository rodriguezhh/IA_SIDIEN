...
def split_vector(folder_source):
    ...
    # Calculamos el índice para dividir el vector en un 60% para entrenamiento y un 40% para prueba y validación
    split_index = int(ceil(len(filenames)*0.6))
    # Tomamos una muestra aleatoria del 60% para entrenamiento
